...
pub const OPUS_SET_QEXT_REQUEST: libc::c_int = 4056;
pub const OPUS_GET_QEXT_REQUEST: libc::c_int = 4057;
pub const OPUS_SET_IGNORE_EXTENSIONS_REQUEST: libc::c_int = 4058;
pub const OPUS_GET_IGNORE_EXTENSIONS_REQUEST: libc::c_int = 4059;
...
pub const OPUS_APPLICATION_RESTRICTED_SILK: libc::c_int = 2052;
pub const OPUS_APPLICATION_RESTRICTED_CELT: libc::c_int = 2053;
