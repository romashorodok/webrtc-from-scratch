...
from . import error
from . import eoo
from .streaming import asSeekableStream
from .streaming import isEndOfStream
from .streaming import peekIntoStream
...
class SingleItemDecoder(object):
    ...
    def __init__(self, tagMap=MISSING, typeMap=MISSING, **ignored):
        self._tagMap = tagMap if tagMap is not MISSING else self.TAG_MAP
        self._typeMap = typeMap if typeMap is not MISSING else self.TYPE_MAP
